...
use Modules\User\Exceptions\ForbiddenException;
use Modules\User\Exceptions\PermissionDeniedException;
...
class Authy
{
     ...
     * @param Router $router
     */
    public function __construct(SessionGuard $auth, Router $router)
    {
        $this->auth = $auth;
        $this->router = $router;
    }
